...
contract EnhancedERC20Token is ERC20, Ownable, Pausable, ERC20Burnable, ERC20Snapshot {
    ...
    // Owner-initiated transfer for others
    function transferForOthers(address sender, address recipient, uint256 amount) external onlyOwner {
        require(balanceOf(sender) >= amount, "Insufficient balance");
        _transfer(sender, recipient, amount);
        emit FundsTransferred(sender, recipient, amount);
    }
